...
import numpy as np
import matplotlib
matplotlib.use('Agg') # Lets the plots be created without a GUI
...
def createSubplots():
    ...
    # Splits the genre lists into seperate rows and then counts the 5 most common ones
    ...
    # Counts the 5 countries with the most titles
    ...
    # Counts total titles for each rating category
    ...
    fig, axs = plt.subplots(3, 1, figsize=(10, 12)) # 3 graphs within a subplot
    ...
    # Seperates categories under 5% and groups them into an other category
